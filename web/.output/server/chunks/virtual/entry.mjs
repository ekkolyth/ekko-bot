...
function createHistory(opts) {
  ...
  return {
    ...
    block: (blocker) => {
      ...
      const blockers = (_b = (_a2 = opts.getBlockers) == null ? void 0 : _a2.call(opts)) != null ? _b : [];
      opts.setBlockers([...blockers, blocker]);
      return () => {
        var _a3, _b2, _c;
        const blockers2 = (_b2 = (_a3 = opts.getBlockers) == null ? void 0 : _a3.call(opts)) != null ? _b2 : [];
        (_c = opts.setBlockers) == null ? void 0 : _c.call(opts, blockers2.filter((b) => b !== blocker));
      };
    },
    flush: () => {
      var _a2;
...
function executeRewriteInput(rewrite, url) {
  var _a2;
  const res = (_a2 = rewrite == null ? void 0 : rewrite.input) == null ? void 0 : _a2.call(rewrite, { url });
  if (res) {
...
async function executeMiddleware$1(middlewares, env, opts) {
  var _a2;
  const globalMiddlewares = ((_a2 = getStartOptions()) == null ? void 0 : _a2.functionMiddleware) || [];
  ...
  return middlewareFn({
    ...
    next: (async (userCtx = {}) => {
      ...
      return nextFn({
        ...
        sendContext: {
          ...ctx.sendContext,
          ...(_a2 = userCtx.sendContext) != null ? _a2 : {}
        },
  ...
  return {
    ...
    options: {
      ...
      client: async ({ next, sendContext, ...ctx }) => {
        ...
        const res = await ((_a2 = options.extractedFn) == null ? void 0 : _a2.call(options, payload));
        return next(res);
      },
      server: async ({ next, ...ctx }) => {
        var _a2;
        const result = await ((_a2 = options.serverFn) == null ? void 0 : _a2.call(options, ctx));
        return next({
          ...ctx,
          result
        });
...
function getDefaultSerovalPlugins() {
  ...
  return [
    ...(_a2 = adapters == null ? void 0 : adapters.map(makeSerovalPlugin)) != null ? _a2 : [],
  ...
  router.serverSsr = {
    ...
    injectScript: (getScript) => {
      return router.serverSsr.injectHtml(async () => {
        ...
        return `<script ${((_a2 = router.options.ssr) == null ? void 0 : _a2.nonce) ? `nonce='${router.options.ssr.nonce}'` : ""} class='$tsr'>${getInitialScript()}${script};$_TSR.c()<\/script>`;
      });
    },
    dehydrate: async () => {
      ...
      const lastMatchId = (_a2 = matchesToDehydrate[matchesToDehydrate.length - 1]) == null ? void 0 : _a2.id;
      if (lastMatchId) {
      ...
      const plugins = (_e2 = (_d = router.options.serializationAdapters) == null ? void 0 : _d.map((t) => makeSsrSerovalPlugin(t, trackPlugins))) != null ? _e2 : [];
      gr(dehydratedRouter, {
...
const NodeResponse = /* @__PURE__ */ (() => {
  var _a2, _b, _c, _body, _init, _headers, _response;
  const NativeResponse = globalThis.Response;
  const STATUS_CODES = ((_c = (_b = (_a2 = globalThis.process) == null ? void 0 : _a2.getBuiltinModule) == null ? void 0 : _b.call(_a2, "node:http")) == null ? void 0 : _c.STATUS_CODES) || {};
  class NodeResponse$1 {
    ...
    get status() {
      var _a3, _b2;
      return ((_a3 = __privateGet(this, _response)) == null ? void 0 : _a3.status) || ((_b2 = __privateGet(this, _init)) == null ? void 0 : _b2.status) || 200;
    }
    get statusText() {
      var _a3, _b2;
      return ((_a3 = __privateGet(this, _response)) == null ? void 0 : _a3.statusText) || ((_b2 = __privateGet(this, _init)) == null ? void 0 : _b2.statusText) || STATUS_CODES[this.status] || "";
    }
    get headers() {
      var _a3;
      ...
      const initHeaders = (_a3 = __privateGet(this, _init)) == null ? void 0 : _a3.headers;
    ...
    get _response() {
      ...
      __privateSet(this, _response, new NativeResponse(__privateGet(this, _body), __privateGet(this, _headers) ? {
    ...
    nodeResponse() {
      ...
      const initHeaders = (_a3 = __privateGet(this, _init)) == null ? void 0 : _a3.headers;
      const headerEntries = ((_b2 = __privateGet(this, _response)) == null ? void 0 : _b2.headers) || __privateGet(this, _headers) || (initHeaders ? Array.isArray(initHeaders) ? initHeaders : (initHeaders == null ? void 0 : initHeaders.entries) ? initHeaders.entries() : Object.entries(initHeaders).map(([k2, v2]) => [k2.toLowerCase(), v2]) : void 0);
...
var H3Event = (_a = class {
  ...
  */
  waitUntil(promise) {
    var _a2, _b;
    (_b = (_a2 = this.req).waitUntil) == null ? void 0 : _b.call(_a2, promise);
  }
  toString() {
  ...
  */
  get node() {
    var _a2;
    return (_a2 = this.req.runtime) == null ? void 0 : _a2.node;
  }
  /**
...
* @internal
*/
__publicField(_a, "__is_event__", true), _a);
...
var HTTPError = class HTTPError2 extends Error {
  constructor(arg1, arg2) {
    ...
    const status = sanitizeStatusCode((details == null ? void 0 : details.status) || ((_a2 = details == null ? void 0 : details.cause) == null ? void 0 : _a2.status) || (details == null ? void 0 : details.status) || (details == null ? void 0 : details.statusCode), 500);
    const statusText = sanitizeStatusMessage((details == null ? void 0 : details.statusText) || ((_b = details == null ? void 0 : details.cause) == null ? void 0 : _b.statusText) || (details == null ? void 0 : details.statusText) || (details == null ? void 0 : details.statusMessage));
...
function toResponse(val, event, config = {}) {
  var _a2;
  if (typeof (val == null ? void 0 : val.then) === "function") return (((_a2 = val.catch) == null ? void 0 : _a2.call(val, (error) => error)) || Promise.resolve(val)).then((resolvedVal) => toResponse(resolvedVal, event, config));
...
async function loadVirtualModule(id) {
  switch (id) {
    case VIRTUAL_MODULES.startManifest:
      return await import('../_/_tanstack-start-manifest_v-C7agnqBj.mjs');
    case VIRTUAL_MODULES.serverFnManifest:
      return await import('../_/_tanstack-start-server-fn-manifest_v-BRDZ_FtR.mjs');
  ...
  const response = await (async () => {
    ...
    try {
      ...
      return new Response(serializedError, {
        status: (_a2 = response2 == null ? void 0 : response2.status) != null ? _a2 : 500,
        statusText: response2 == null ? void 0 : response2.statusText,
        headers: {
          "Content-Type": "application/json",
          [X_TSS_SERIALIZED]: "true"
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import('../_/router-DS8VtDbX.mjs').then((n) => n.r);
    }
    if (startEntry === null) {
  ...
  const startRequestResolver = async (request, requestOpts) => {
    ...
    const getRouter = async () => {
      ...
      router.update({
        ...
        isShell,
        isPrerendering,
        origin: (_a3 = router.options.origin) != null ? _a3 : origin,
        ...{
    ...
    const startOptions = await ((_a2 = (await getEntries()).startEntry.startInstance) == null ? void 0 : _a2.getOptions()) || {};
...
async function handleServerRoutes({
  ...
  const middlewares = flattenMiddlewares(
    matchedRoutes.flatMap((r) => {
      var _a2;
      return (_a2 = r.options.server) == null ? void 0 : _a2.middleware;
    }).filter(Boolean)
...
export { createServerRpc as a, createServerFn as c, entry$1 as e, json as j };
